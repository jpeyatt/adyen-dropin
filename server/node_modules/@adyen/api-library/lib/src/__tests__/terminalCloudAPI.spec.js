...
describe("Terminal Cloud API", () => {
    ...
    test.each([isCI, true])("should make an async refund request, isMock: %p", async (isMock) => {
        ...
        const terminalAPIRefundRequest = base_1.createTerminalAPIRefundRequest((_b = (_a = terminalAPIResponse.SaleToPOIResponse) === null || _a === void 0 ? void 0 : _a.PaymentResponse) === null || _b === void 0 ? void 0 : _b.POIData.POITransactionID);
